...
std::vector<double> evaluate_f_and_N_derivatives(std::vector<double> coefficients, double t, int N) {
...
std::vector<float> cumparab(const std::vector<float>& x, const std::vector<float>& fx) {
