...
// Standard deviation parameters for x, x_dot, x_double_dot to generate appropriate perturbed goals. EGO REF FRAME
constexpr std::array<float, 3> SIGMA_X = {4.0, 1.0, 2.0};

// Standard devaition parameters for y, y_dot, y_double_dot to generate appropriate perturbed goals. EGO REF FRAME
constexpr std::array<float, 3> SIGMA_Y = {0.5, 1.0, 0.5};

constexpr std::array<float, 3> SIGMA_YAW = {0.17, 1.0, 1.0};

// Standard deviation for time (as in the time taken to finish the maneuver)
